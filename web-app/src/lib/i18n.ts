...
export const dict = {
  ...
  search_title: { tr: "Ara", en: "Search" },
  search_button: { tr: "Notlarda ara", en: "Search notes" },
  search_placeholder: { tr: "Başlık, kategori veya etiket yaz…", en: "Type a title, category, or tag…" },
  search_no_results: { tr: "Eşleşen not bulunamadı.", en: "No matching notes found." },
